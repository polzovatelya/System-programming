...
{   
    ...
    hBtn2 = CreateWindow(TEXT("BUTTON"), TEXT("Вторая"), WS_VISIBLE | WS_CHILD, 250, 200, 80, 26, hWnd, (HMENU)BUTTON1_ID, NULL, NULL);
        ...
        hStatic = CreateWindow(TEXT("STATIC"), TEXT("Вывод квадрата"), WS_CHILD | WS_VISIBLE | ES_RIGHT, 250, 240, 150, 26, hWnd, (HMENU)STATIC_ID, NULL, NULL);
        hStatic1 = CreateWindow(TEXT("STATIC"), TEXT("Вывод количества возникающих событий"), WS_CHILD | WS_VISIBLE | ES_RIGHT, 250, 300, 300, 40, hWnd, (HMENU)STATIC_ID1, NULL, NULL);
        hStatic2 = CreateWindow(TEXT("STATIC"), TEXT("События"), WS_CHILD | WS_VISIBLE | ES_RIGHT, 250, 400, 500, 100, hWnd, (HMENU)STATIC_ID2, NULL, NULL);
    ...
    case WM_LBUTTONUP:
    {
        _tcscat_s(event_clk, _T("Отпушена Левая кнопка мыши;"));
        SetWindowText(hStatic2, event_clk);
    }
    break;
