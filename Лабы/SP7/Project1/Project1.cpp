...
RECT mainRect = {50, 50,300, 300 };	// начальное положение Солнышка
int x_plane = 50;				// х-координата его левой границы
int hWidth = 1200, hHeight = 800;	// ширина и высота окна
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   hAnimateBtn = CreateWindow(L"BUTTON", L"Запустить анимацию", WS_VISIBLE | WS_CHILD | BS_PUSHBUTTON, 0, 0, 200, 25, hWnd, (HMENU)idAnimateBtn, hInstance, NULL);
   hMetaBtn = CreateWindow(L"BUTTON", L"Создать метафайл", WS_VISIBLE | WS_CHILD | BS_PUSHBUTTON,210, 0, 200, 25, hWnd, (HMENU)idMetaBtn, hInstance, NULL);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        hPlaneImg = LoadBitmap(hInst, MAKEINTRESOURCE(IDB_SUN));
    }
    break;
    case WM_TIMER:
    {
        if (mainRect.right < hWidth) {
            x_plane += 10;
            mainRect.right += 10;
